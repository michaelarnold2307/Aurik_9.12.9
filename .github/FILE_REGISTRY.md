...
| scripts/benchmark_effizienz_matrix.py | ACTIVE | tooling/benchmark | ja | — | Effizienz-Matrix-Benchmark: UV3-Modi (FAST/BALANCED/MAXIMUM) × Ebenen-Schalter (PMGG/Adaptive-Skipping); Stufen-Timing, RSS-Verlauf, JSON-Report (2026-09-06) |
