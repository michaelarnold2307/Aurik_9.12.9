...
| scripts/benchmark_effizienz_matrix.py | ACTIVE | tooling/benchmark | ja | — | Effizienz-Matrix-Benchmark: UV3-Modi (FAST/BALANCED/MAXIMUM) × Ebenen-Schalter (PMGG/Adaptive-Skipping); Stufen-Timing, RSS-Verlauf, JSON-Report; CI-Gate via --ci (--enforce-budget gegen copilot-instructions §Performance-Budget, --bootstrap-ci 95 %-CI, --profile-top-phases) (2026-09-06) |
